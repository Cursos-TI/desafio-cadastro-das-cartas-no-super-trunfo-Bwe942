...
int main (){
    ...
    int pontost , num, pontost2 , num2, escolhaJogador, atributo;
...
// Menu interativo
    ...
    {
        case 1:
            printf("Selecione o atributo da carta para comparar:\n");
            printf("1 - População\n");
            printf("2 - Área\n");
            printf("3 - PIB\n");
        ...
        case 2:
            printf("O jogador deverá escolher um atributo das cartas para a batalha.\n");
